...
export const TEMPLATES: Template[] = [
    // --- 一、角色与肖像类 (Character & Portrait) ---
    {
        ...
        structure: {
            ...
            modifiers: {
                artisticReference: 'Roger Deakins, Annie Leibovitz',
                lighting: '伦勃朗光，戏剧性阴影',
                visualLayers: "前景雪花模糊，主体锐利，背景强景深虚化",
    ...
    },
    {
        ...
        structure: {
            ...
            modifiers: {
                artisticReference: 'Mika Pikazo, ASK',
                lighting: '轮廓光，霓虹发光',
                visualLayers: "前景UI界面悬浮，中景角色动态，背景几何图形",
    ...
    },
    {
        ...
        structure: {
            ...
            modifiers: {
                artisticReference: 'Yoshitaka Amano, Yoji Shinkawa',
                lighting: '平光，无阴影干扰',
                visualLayers: "统一平面层",
    ...
    },
    {
        ...
        structure: {
            ...
            modifiers: {
                artisticReference: 'William Eggleston, Stephen Shore',
                lighting: '暖黄夕阳，漏光效果 (Light Leaks)',
                visualLayers: "前景车身反光，中景人物，背景街道虚化",
    ...
    },
    {
        ...
        structure: {
            ...
            style: 'CG 渲染，超写实',
            modifiers: {
                artisticReference: 'Peter Jackson (LOTR), Blizzard Cinematics',
                lighting: '生物荧光，点光',
                visualLayers: "前景漂浮孢子，中景面部特写，背景深邃森林",
    ...
    // --- 二、场景与氛围类 (Scene & Atmosphere) ---
    {
        ...
        structure: {
            ...
            modifiers: {
                artisticReference: 'Denis Villeneuve (Dune), Ridley Scott',
                lighting: '黄金时刻，长阴影',
                visualLayers: "前景沙丘纹理，中景遗迹剪影，背景巨大天体",
    ...
    },
    {
        ...
        structure: {
            ...
            modifiers: {
                artisticReference: 'Hayao Miyazaki, Kazuo Oga',
                lighting: '明亮的日光，透彻',
                visualLayers: "前景花草摇曳，中景木屋，背景连绵雪山",
    ...
    },
    {
        ...
        structure: {
            ...
            modifiers: {
                artisticReference: 'Syd Mead, Blade Runner 2049',
                lighting: '各种霓虹灯光，反射',
                visualLayers: "前景湿润路面反射，中景人群与载具，背景无尽高楼",
    ...
    },
    {
        ...
        structure: {
            ...
            modifiers: {
                artisticReference: 'Makoto Shinkai, Thomas Kinkade',
                lighting: '梦幻柔光',
                visualLayers: "前景云雾缭绕，中景主浮空岛，背景远方岛屿群",
    ...
    },
    {
        ...
        structure: {
            ...
            modifiers: {
                artisticReference: 'Zaha Hadid, Architectural Digest',
                lighting: '漫射自然光，柔和',
                visualLayers: "前景家具质感，中景空间布局，背景窗外自然景观",
    ...
    // --- 三、产品与商业类 (Product & Commercial) ---
    {
        ...
        structure: {
            ...
            modifiers: {
                artisticReference: 'Nike Commercials, Behance Graphic Design',
                lighting: '高调摄影，边缘光',
                visualLayers: "前景动态鞋带，中景主体鞋身，背景动态图形",
    ...
    },
    {
        ...
        structure: {
            ...
            modifiers: {
                artisticReference: 'Dieter Rams, Apple Design',
                lighting: '演播室灯光，反射光',
                visualLayers: "主体产品清晰，背景深邃虚化",
                composition: '45度角展示',
                details: '内部芯片结构隐约可见',
                effects: '焦散，光泽',
                typography: '',
    ...
    },
    {
        ...
        structure: {
            ...
            modifiers: {
                artisticReference: 'Bauhaus, Swiss Style Design',
                lighting: '平光',
                visualLayers: "平面层",
    ...
    },
    {
        ...
        structure: {
            ...
            modifiers: {
                artisticReference: 'Vogue, Chanel Campaign',
                lighting: '柔光箱，无阴影',
                visualLayers: "单一平面层，物品与背景层次分明",
    ...
    },
    {
        ...
        structure: {
            ...
            modifiers: {
                artisticReference: 'Sony Product Photography',
                lighting: '通透的布光，强调质感',
                visualLayers: "主体产品，底部投影",
                composition: '居中，完整展示',
                details: '高光，材质纹理',
                effects: '无杂质',
                typography: '',
    ...
    // --- 四、风格化与艺术类 (Style & Art) ---
    {
        ...
        structure: {
            ...
            modifiers: {
                artisticReference: 'Wu Guanzhong (吴冠中), Qi Baishi (齐白石)',
                lighting: '散点透视，无特定光源',
                visualLayers: "近景墨色浓重，远景淡墨晕染",
    ...
    },
    {
        ...
        structure: {
            ...
            modifiers: {
                artisticReference: 'Frank Frazetta, Moebius',
                lighting: '鲜艳的色彩，高饱和',
                visualLayers: "前景宇航员背影，中景奇异植物，背景双月",
                composition: '充满画面',
    ...
    },
    {
        ...
        structure: {
            ...
            modifiers: {
                artisticReference: 'Studio Ghibli, Hayao Miyazaki',
                lighting: '美丽的自然光，透视',
                visualLayers: "前景桌上杂物，中景房间陈设，背景窗外风景",
    ...
    },
    {
        ...
        structure: {
            ...
            modifiers: {
                artisticReference: 'eBoy, 8-bit games',
                lighting: '像素化的光影',
                visualLayers: "等轴测层级分明",
    ...
    },
    {
        ...
        structure: {
            ...
            modifiers: {
                artisticReference: 'H.R. Giger, Zdzisław Beksiński',
                lighting: '顶光，强烈的明暗对比 (Chiaroscuro)',
                visualLayers: "主体雕塑，背景纯黑虚空",
                composition: '庄严，对称',
                details: '大理石纹理，破碎的翅膀',
                effects: '烟雾',
                typography: '',
